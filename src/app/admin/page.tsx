...
import { FileText, Sparkles, Building2, Wallet, Users, GraduationCap } from 'lucide-react';
...
const ABAS = [
  ...
  { id: 'alunos', label: 'Alumnos', icon: Users, componente: null, emBreve: true },
  { id: 'profesores', label: 'Profesores', icon: GraduationCap, componente: null, emBreve: true },
];
...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#030914] text-white/90 font-sans antialiased flex flex-col">

      <header className="bg-[#080C16]/90 border-b border-white/10 px-6 py-4 flex items-center justify-between shadow-lg shrink-0">
      ...
      <main className="flex-1 p-6 max-w-7xl w-full mx-auto space-y-6 min-h-0 flex flex-col">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          <div className="bg-[#080C16]/60 border border-white/10 rounded-2xl p-6">
