...
const BENEFICIOS_PLANOS: any = {
  grupo: {
    PT: [
      ...
      'Conversa por voz com a IA — você envia áudio, ela responde com áudio',
      'Tira-dúvidas com a IA',
      'Sistema de feedback automático — identifica seus erros e envia a correção instantaneamente',
    ...
    EN: [
      ...
      'Voice conversation with AI — you send audio, it responds with audio',
      'Ask questions with AI',
      'Automatic feedback system — identifies your mistakes and gives instant corrections',
    ...
    ES: [
      ...
      'Conversación por voz con la IA — envías audio, ella responde con audio',
      'Tira-dudas con la IA',
      'Sistema de feedback automático — identifica tus errores y devuelve la corrección al instante',
