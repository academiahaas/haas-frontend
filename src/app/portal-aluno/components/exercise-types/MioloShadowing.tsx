...
export default function MioloShadowing({ onSelectCorrect, onSelectWrong }: MioloShadowingProps) {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-between items-stretch text-left font-mono animate-fade-in min-h-0 flex-1 gap-4">
      ...
      <div className="bg-[#020B12] border border-slate-800 rounded-xl py-5 px-3 text-center font-sans text-[clamp(14px,4vw,16px)] font-black text-slate-200 tracking-wide flex-1 flex items-center justify-center">
        "{referencePhrase}"
      </div>
