      ...
      <div onClick={(e) => { if (e.target === e.currentTarget) { if (typeof interromperMentora === 'function') interromperMentora(); onClose(); } }} className="w-full max-w-[94vw] flex-1 flex flex-col md:flex-row gap-6 text-left justify-center items-center mx-auto my-auto py-2 cursor-default">
        ...
        <div className="w-full md:w-[60%] h-[66vh] min-h-[480px] max-h-[600px] bg-[#0B1528] border border-white/[0.04] rounded-[24px] p-5 flex flex-col justify-between backdrop-blur-md relative overflow-hidden shadow-2xl">
              ...
              <div className="w-full h-full flex flex-col items-center justify-center text-center p-4 gap-4 select-none">
                {!caixaAberta ? (
                  ...
                  <div className="flex flex-col items-center justify-center gap-3">
                    <div className="w-14 h-14 bg-[#22C55E]/20 rounded-full flex items-center justify-center text-[#22C55E] border border-[#22C55E]/30">
          ...
          <div className="w-full pt-4 border-t border-white/[0.03] flex justify-between items-center gap-4">
            <button 
              onClick={() => { if(desafioIniciado) { tocarSom('click'); handleNextMission(); } }} disabled={!desafioIniciado}
