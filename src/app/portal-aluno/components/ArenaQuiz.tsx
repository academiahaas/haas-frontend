    ...
    try {
      ...
      await fetch(`${supabaseUrl}/rest/v1/user_unit_progress?on_conflict=user_id,unit_id`, {
        ...
        body: JSON.stringify({
          ...
          activity_type: (activityType || jogoSelecionado) === 'paragrafos' ? '8' : ((activityType || jogoSelecionado) === 'shadowing' ? '10' : ((activityType || jogoSelecionado) === 'spelling' ? '11' : ((activityType || jogoSelecionado) === 'traducao' ? '12' : ((activityType || jogoSelecionado) === 'velocidade' ? '13' : (activityType || jogoSelecionado || 'geral'))))),
          exercise_id: (activityType || jogoSelecionado) === 'shadowing' || (activityType || jogoSelecionado) === 'spelling' || (activityType || jogoSelecionado) == 'traducao' || (activityType || jogoSelecionado) == 'velocidade' ? String(dynamicExerciseId || typeof subUnidadeIndex === 'string' ? subUnidadeIndex : '09adf4ff-71ed-4b2b-982e-07c22fcd2cf0') : (dynamicExerciseId ? String(dynamicExerciseId) : String(jogoSelecionado || '8')),
          score: scoreObtido ?? 0,
