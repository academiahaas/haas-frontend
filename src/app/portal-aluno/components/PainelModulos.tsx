                ...
                >
                  ...
                  <div className="flex items-center justify-end">
                    <button 
                      ...
                      className="w-full md:w-auto bg-cyan-400 hover:bg-purple-600 text-black font-bold uppercase text-xs tracking-wider px-6 py-3 rounded-lg transition-all duration-300 hover:shadow-[0_0_15px_rgba(168, 85, 247, 0.3)]"
                    >
                      Avançar
                    </button>
                  </div>
