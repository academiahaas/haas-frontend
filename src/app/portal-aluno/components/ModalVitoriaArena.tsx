...
export default function ModalVitoriaArena({ 
  ...
  return (
    <div className="w-full max-w-md mx-auto bg-slate-900 border border-cyan-500/40/30 rounded-3xl p-6 shadow-[0_0_50px_rgba(168, 85, 247, 0.1)] backdrop-blur-md text-center space-y-6">
      ...
      <div className="space-y-2.5 pt-2">
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3.5 bg-gradient-to-r from-cyan-400 to-purple-400 hover:from-purple-400 hover:to-purple-300 text-black text-xs font-mono font-bold uppercase tracking-wider rounded-xl shadow-[0_4px_20px_rgba(168, 85, 247, 0.2)] transition-all transform active:scale-95"
        >
