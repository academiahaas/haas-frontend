  ...
  return (
    <div className="bg-[#0A131C] border border-[#1C2C39] rounded-2xl p-3 flex justify-between items-center shadow-2xl">
      <nav className="flex gap-5 text-[10px] font-black uppercase tracking-wider font-sans items-center pl-1">
        <button className="flex flex-col items-center justify-center gap-0.5 text-purple-400 font-black border-b-2 border-purple-400 pb-0.5 transition-all">
          <Home size={15} className="text-purple-400 fill-purple-400/20" /> <span>{t.inicio}</span>
        </button>
