...
function MascoteRoboAI({ devePiscar = false, idioma = "PT", olharDireta = false }) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-1.5 rounded-xl border border-cyan-500/30 bg-[#070d19]/80 backdrop-blur-md w-16 h-16 shrink-0 select-none">
      ...
      <div className="flex-1 p-4 flex flex-col gap-4 overflow-hidden z-10 justify-between">
        ...
        {(abaAtiva as string) === 'inicio' && (
          <div className="flex flex-col gap-4 h-full">
            <div className="bg-gradient-to-br from-[#091527] to-[#050b14] border border-white/[0.05] p-5 rounded-2xl shadow-xl flex-1">
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white font-black py-4 px-4 rounded-xl text-[clamp(12px,3.8vw,18px)] uppercase tracking-widest flex items-center justify-center gap-2 border-none active:scale-[0.98] transition-all shadow-lg shadow-orange-500/10 cursor-pointer shrink-0"
            >
...
{/* CONTAINER DOS MIOLOS COM CABEÇALHO E RODAPÉ DE VALIDAÇÃO */}
        ...
        {((abaAtiva as string) === "perfil") && (
          <div className="flex-1 w-full min-h-full overflow-y-auto px-0 pb-10 pt-0 flex flex-col gap-4 scrollbar-none" >
