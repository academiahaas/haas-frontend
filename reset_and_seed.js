...
async function run() {
  ...
  try {
    console.log("💥 Esvaziando a tabela de lições para sumir com os fantasmas...");
    await client.query("TRUNCATE TABLE lessons CASCADE;");
    
    const moduleId = "d6a07db6-6d79-43a7-91ef-9dee31b597d5";
    console.log(`📝 Inserindo a lista oficial de 15 lições no módulo: ${moduleId}`);
    ...
    console.log('✨ BANCO LIMPO E ATUALIZADO! Exatamente 15 lições únicas salvas!');
