...
// Conexão via IP DIRETO do pooler AWS São Paulo + porta 6543
const connectionString = "postgres://postgres.jdppxfokfhqjudwfwckd:aZx1jscjMZFvc6YP@54.207.27.17:6543/postgres";

async function run() {
  console.log("🚀 [HAAS MOTOR - IP FIXO POOLER] Gravando Unidade 4.4 sem depender de DNS...");
  ...
  try {
    ...
    if (res.rows.length === 0) {
      console.log("❌ Unidade 4.4 não encontrada.");
      return;
    }
    ...
    console.log("✨ [VITÓRIA] Unidade 4.4 gravada com sucesso absoluto pulando o DNS!");
  } catch (err) {
