...
// Usando o IP direto na string de conexão oficial de banco para ignorar o erro de DNS
const connectionString = "postgres://postgres:aZx1jscjMZFvc6YP@15.228.140.231:5432/postgres";

async function run() {
  console.log("🚀 [HAAS MOTOR] Forçando gravação da Unidade 2.2 via IP direto de banco...");
  ...
  try {
    ...
    console.log(`📥 Gravando lote de 45 conteúdos para a Unidade 2.2...`);
    ...
    console.log("✨ [CONCLUÍDO COM MAESTRIA] Unidade 2.2 integrada perfeitamente no Supabase!");
