...
# SLIDE 2: PRESENÇA & INTEGRANTES (Adaptado para Aula Particular ou Turma)
sl2 = base_slide(2)
...
# SLIDES 12 A 19: CONVERSAÇÃO (8 PERGUNTAS)
perguntas_config = [
...
prs.save(out_path)
print(f"🎉 MODELO 1 MASTER OFICIAL CONCLUÍDO E SALVO EM: {out_path}")
