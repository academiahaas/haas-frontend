...
async function run() {
  console.log("🚀 [HAAS MOTOR] Salvando Unidade 2.2 de Tecnologia pelo caminho oficial comercial...");
  ...
  try {
    ...
    // Mapeamento direto para a lição de tecnologia (ID 15)
    const licaoId = 15;
    ...
    console.log(`📥 Gravando lote de 45 conteúdos para a Unidade 2.2 do A2...`);
