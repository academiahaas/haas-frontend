...
async function run() {
  console.log("🚀 [HAAS MOTOR] Conectando ao domínio oficial para salvar a Unidade 1.5...");
  ...
  try {
    ...
    console.log(`📥 Gravando lote de ${questoesGeradas.length} conteúdos para a Unidade 1.5 do A2...`);
    ...
    console.log("✨ [CONCLUÍDO] Módulo 1 do A2 integrado com sucesso!");
