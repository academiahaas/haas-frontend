...
// ID sequencial da lição 1.5 na tabela 'lessons' do seu banco
const licaoId = 14; 

let sqlOutput = `-- Carga de Dados Definitiva - Unidade 1.5 (A2)\n`;
...
for(let i = 1; i <= 45; i++) {
  ...
  // Escapa aspas simples para não quebrar a query SQL
...
fs.writeFileSync('carga_unidade_15.sql', sqlOutput);
console.log("✨ [SUCESSO LOCAL] Arquivo 'carga_unidade_15.sql' gerado dentro da VPS!");
