...
// Usando a porta estável de pooling (6543) com o parâmetro de modo transaction
const connectionString = "postgres://postgres.jdppxfokfhqjudwfwckd:aZx1jscjMZFvc6YP@aws-0-sa-east-1.pooler.supabase.com:6543/postgres?sslmode=require";

async function run() {
  console.log("🚀 [HAAS MOTOR] Iniciando geração da Unidade 4.4 via Porta Pooler 6543...");
  ...
  try {
    ...
    console.log("✨ [ALTO ALINHAMENTO] Unidade 4.4 salva via rota pooler estável!");
